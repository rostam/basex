...
public final class DialogPackages extends BaseXDialog {
  ...
  public DialogPackages(final GUI main) {
    ...
    final BaseXBack table;
    if (Prop.langright) table = new BaseXBack(new RTLTableLayout(4, 2, 16, 0)).border(5);
    else table = new BaseXBack(new TableLayout(4, 2, 16, 0)).border(5);
    ...
    final BaseXBack ss;
    if (Prop.langright) ss = new BaseXBack(new RTLTableLayout(1, 2, 8, 0)).border(8, 0, 0, 0);
    else ss = new BaseXBack(new TableLayout(1, 2, 8, 0)).border(8, 0, 0, 0);
